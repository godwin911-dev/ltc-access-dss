...
|---|---|---|---|---|
| Nursing facility beds, change to 2035 | −12% | **+12%** | −18% | CMS facility closure rates 2020 to 2024; optimistic assumes reversal through state and CMS investment |
| Direct-care workforce deficit | +20% | **−5%** | +30% | PHI direct-care workforce projections; optimistic assumes wage investment reduces turnover |
| Home health coverage | −7% | **+10%** | −12% | CMS rural HHA contraction; optimistic assumes HCBS waiver expansion |
| Disability prevalence, 65+ | +8% | **0%** | +12% | BRFSS age-adjusted trend; optimistic assumes prevalence held flat |
...
represents sustained policy success across every controllable variable: facility
expansion reversing the closure trend, wage investment reducing direct-care turnover,
HCBS waiver expansion, and age-adjusted disability prevalence held flat.

**A structural note.** The 65+ population share follows the same SSA projection in all
three scenarios and carries 45% of the index weight, so scenarios vary the rate of
deterioration rather than its direction. Statewide demand rises in every scenario.
Under the optimistic assumptions above, critical tracts still increase from 383 in 2025
to 677 by 2035. This is a substantive finding rather than a modelling artifact:
demographic momentum through 2035 is determined by the population already alive.
